...
class CSVDataExtractor:
    ...
    def extract_hs_code_wise_tables(self):
        ...
        tables = {}
        print("Len is",len(header_indices))
...
path = r"C:\Users\DELL\Downloads\PWSAutomate\EFS-537624.csv"
csv = CSVDataExtractor(path)
for key,entry in csv.hs_code_wise_tables.items():
    if entry['sub_table']:
        print(key,entry['sub_table'])
